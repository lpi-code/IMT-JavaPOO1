...
public class DrawGeometryView {
    ...
    public void drawPopups(String message, TextField coordP1, TextField coordP2, TextField coordP3, TextField coordP4, ChoiceBox color,Button validButton) {
        ...
        coordP1.setMaxWidth(100);
        coordP2.setMaxWidth(100);
        coordP3.setMaxWidth(100);
        coordP4.setMaxWidth(100);
        this.popupVbox.getChildren().addAll(label1, coordP1, label2, coordP2, label3, coordP3, label4, coordP4, color,validButton);
